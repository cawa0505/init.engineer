...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('social:media-cards-update 20')->everyThirtyMinutes();
        // $schedule->command('social:media-cards-update 6')->everyTenMinutes();
        // $schedule->command('social:media-cards-update 10')->everyFiveMinutes();
        ...
        $schedule->command('social:comments-update 20')->everyThirtyMinutes();
        // $schedule->command('social:comments-update 6')->everyTenMinutes();
        // $schedule->command('social:comments-update 10')->everyFiveMinutes();
