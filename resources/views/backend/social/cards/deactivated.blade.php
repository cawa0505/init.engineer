...
@section('title', __('labels.backend.social.cards.management') . ' | ' . __('labels.backend.social.cards.deactivated'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.social.cards.deactivated')</small>
                </h4>
            </div>
            <!--col-->
        </div>
