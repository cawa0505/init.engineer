...
<div class="container-fluid">
    ...
    <div class="row flex-column-reverse flex-md-row my-2">
        ...
        <div class="col-12 col-md-12 col-lg-7 mx-auto my-2 px-0">
            ...
            <iframe src="https://yklm.schl.tw" width="100%" height="680" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
        </div>
